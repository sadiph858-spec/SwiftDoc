...
public class PdfToolsActivity extends AppCompatActivity {
    ...
    private void convertPdfToImages(){
        ...
        AsyncTask.execute(()->{try{
            File imgDir=new File(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_PICTURES),"SwiftDoc");
